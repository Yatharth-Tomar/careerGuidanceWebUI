...
import { getAllCourses } from "../../assets/Redux/slices/courseSlice";
...
function CourseList() {
  ...
  return (
    <>
      <HomeLayout>
        <div className="bg-white dark:bg-gray-800 flex justify-center items-center w-screen h-40 p-5">
          <div className="border border-gray-200 p-2 rounded-md shadow-lg shadow-orange-300">
            <div className="flex items-end gap-1">
              ...
              <span className="text-6xl font-semibold dark:text-white">u</span>
              <span className="text-6xl font-semibold dark:text-white">r</span>
              <span className="text-6xl font-semibold text-orange-500">ses</span>
            </div>
          </div>
        </div>
        ;
        <div className="flex p-5 pb-10 flex-wrap items-center">
